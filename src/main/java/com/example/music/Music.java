...
public class Music {
   ...
   //private static final String MUSIC_PATH = Environment.getExternalStorageDirectory() + "/netease/cloudmusic/Music";
    private static final String MUSIC_PATH = Environment.getExternalStorageDirectory()  +"/mnt/sdcard/Music";
    ...
    public Music() {
        ...
        try {
            ...
            File music_path = new File(Environment.getExternalStorageDirectory(),"Music");//创建文件对象
            //File music_path = Environment.getExternalStoragePublicDirectory("/mnt/sdcard/Music");
    ...
    public void randomPosition(){
        int random = (int)(Math.random()*musicNameList.size());
        songNum = random;
    }
    /*
    播放第position歌
     */
    public void palyOnPosition(int position){
